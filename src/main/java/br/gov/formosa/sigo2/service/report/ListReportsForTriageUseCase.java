...
public class ListReportsForTriageUseCase {

    private final ReportRepository reportRepository;
    private final ReportMapper reportMapper;

    @Transactional(readOnly = true)
    public Page<ReportDTOs.ReportSummaryDTO> execute(Pageable pageable) {
        Page<Report> reports = reportRepository.findByStatus(ReportStatus.RECEBIDA, pageable);
